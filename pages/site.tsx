    ...
    <>
            ...
            <div className="col-12">
              <nav className="main-nav">
                ...
                <a href="" className="logo">
                  <img src="assets/images/tclog.png" alt="" width="100px;" />
                </a>
                ...
                <ul className="nav">
                  ...
                  <li><a target="_blank" href="https://explorer.solana.com/address/tc2aHSCjMe7mr8gPW84i5CNv9Wdb8671NkapxSRbZJ5">Our Token</a></li>
                  {/* <li><a href="details.html">Details</a></li>
                        <li><a href="streams.html">Streams</a></li> */}
                  <li>
                    {/* <a href="profile.html">Connect Wallet <img src="assets/images/profile-header.jpg" alt="" /></a> */}
          ...
          <div className="col-lg-12">
            <div className="page-content">
                ...
                <div className="row">
                  <div className="col-lg-7">
                    <div className="header-text">
                      <h6>Welcome To Touch Coin</h6>
                      <h4>Up To <em>$500k Token</em> will be gifted as pre-launch for early birds</h4>
                      <h6>Gas Fee Might Be Included</h6>
                      <div className="main-button">
                        <CustomBtn>
                          Claim Reward
                        </CustomBtn>
                ...
                <div className="row">
                  <div className="col-lg-12">
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-12">
                        <div className="main-button">
                          <a target="_blank" href="https://explorer.solana.com/address/tc2aHSCjMe7mr8gPW84i5CNv9Wdb8671NkapxSRbZJ5">Discover Popular</a>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="gaming-library">
                ...
                <div className="col-lg-12">
                  <div className="main-button">
                    <a target="_blank" href="https://explorer.solana.com/address/tc2aHSCjMe7mr8gPW84i5CNv9Wdb8671NkapxSRbZJ5">View Your Library</a>
                  </div>
                </div>
              </div>
      ...
      <footer>
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <p>Copyright © 2024 <a href="#">Touch Coin</a> Company. All rights reserved. </p>
